...
export const APIKEY_PROVIDERS = {
  ...
  "qwen-api": { id: "qwen-api", alias: "qwa", name: "Qwen API", icon: "psychology", color: "#10B981", website: "https://chat.qwen.ai/", notice: { text: "Image (qwen-image) · Image Edit · Video (qwen-video) — uses your chat.qwen.ai session token. Token expires; re-paste a fresh one when requests start failing with 401.", apiKeyUrl: "https://chat.qwen.ai/" }, serviceKinds: ["image", "imageEdit", "video"], imageConfig: { baseUrl: "https://qwen.aikit.club/v1/images/generations", method: "POST", authType: "apikey", authHeader: "bearer" } },
...
export const MEDIA_PROVIDER_KINDS = [
  ...
  { id: "imageEdit",   label: "Image Edit",     icon: "auto_fix_high",     endpoint: { method: "POST", path: "/v1/images/edits" } },
